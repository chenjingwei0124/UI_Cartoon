...
@interface JwBannerView ()<UIScrollViewDelegate>
...
- (void)setArray:(NSArray *)array{
    ...
    for (int i = 0; i < self.array.count; i++) {
        ...
        JwBanner *banner = self.array[i];
        [img sd_setImageWithURL:[NSURL URLWithString:banner.pic] placeholderImage:nil];
